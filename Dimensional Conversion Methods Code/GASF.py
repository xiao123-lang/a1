...
filename = "DataAverage.xlsx"  # Path to the file to be processed
savepath = "./data"               # GAF Image Save Path
img_sz = 165       # Determine the size of the generated GAF image
method ='summation'
...
for i in range(img_num):  # Save each image
    ...
    image.imsave(img_save_path, gaf_img)                # Save Image (save image)
